...
Version  : 1.14.11
Release  : 416
URL      : https://github.com/boto/boto3/archive/1.14.11/boto3-1.14.11.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.14.11/boto3-1.14.11.tar.gz
...
%prep
%setup -q -n boto3-1.14.11
cd %{_builddir}/boto3-1.14.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593186806
...
cp %{_builddir}/boto3-1.14.11/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
