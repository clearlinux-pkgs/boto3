...
Source0  : https://github.com/boto/boto3/archive/1.35.87/boto3-1.35.87.tar.gz
...
%prep
%setup -q -n boto3-1.35.87
cd %{_builddir}/boto3-1.35.87
pushd ..
cp -a boto3-1.35.87 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735066395
