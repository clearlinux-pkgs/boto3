...
Version  : 1.34.117
Release  : 1364
URL      : https://github.com/boto/boto3/archive/1.34.117/boto3-1.34.117.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.117/boto3-1.34.117.tar.gz
...
%prep
%setup -q -n boto3-1.34.117
cd %{_builddir}/boto3-1.34.117
pushd ..
cp -a boto3-1.34.117 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717423349
