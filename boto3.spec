...
Source0  : https://github.com/boto/boto3/archive/1.17.64/boto3-1.17.64.tar.gz
...
%prep
%setup -q -n boto3-1.17.64
cd %{_builddir}/boto3-1.17.64
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620137605
...
cp %{_builddir}/boto3-1.17.64/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
