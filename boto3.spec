...
Source0  : https://github.com/boto/boto3/archive/1.14.21/boto3-1.14.21.tar.gz
...
%prep
%setup -q -n boto3-1.14.21
cd %{_builddir}/boto3-1.14.21
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594923844
...
cp %{_builddir}/boto3-1.14.21/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
