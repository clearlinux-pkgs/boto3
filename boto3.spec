...
Source0  : https://github.com/boto/boto3/archive/1.38.12/boto3-1.38.12.tar.gz
...
%prep
%setup -q -n boto3-1.38.12
cd %{_builddir}/boto3-1.38.12
pushd ..
cp -a boto3-1.38.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746733205
