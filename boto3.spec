...
Version  : 1.26.144
Release  : 1112
URL      : https://github.com/boto/boto3/archive/1.26.144/boto3-1.26.144.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.144/boto3-1.26.144.tar.gz
...
%prep
%setup -q -n boto3-1.26.144
cd %{_builddir}/boto3-1.26.144
pushd ..
cp -a boto3-1.26.144 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685562799
