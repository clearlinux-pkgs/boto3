...
Version  : 1.34.153
Release  : 1400
URL      : https://github.com/boto/boto3/archive/1.34.153/boto3-1.34.153.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.153/boto3-1.34.153.tar.gz
...
%prep
%setup -q -n boto3-1.34.153
cd %{_builddir}/boto3-1.34.153
pushd ..
cp -a boto3-1.34.153 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722649513
