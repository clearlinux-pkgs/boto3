...
Version  : 1.26.54
Release  : 1023
URL      : https://github.com/boto/boto3/archive/1.26.54/boto3-1.26.54.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.54/boto3-1.26.54.tar.gz
...
%prep
%setup -q -n boto3-1.26.54
cd %{_builddir}/boto3-1.26.54
pushd ..
cp -a boto3-1.26.54 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674258220
