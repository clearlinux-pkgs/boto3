...
Version  : 1.38.17
Release  : 1583
URL      : https://github.com/boto/boto3/archive/1.38.17/boto3-1.38.17.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.38.17/boto3-1.38.17.tar.gz
...
%prep
%setup -q -n boto3-1.38.17
cd %{_builddir}/boto3-1.38.17
pushd ..
cp -a boto3-1.38.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747338462
