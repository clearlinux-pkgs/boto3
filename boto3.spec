...
Version  : 1.24.52
Release  : 914
URL      : https://github.com/boto/boto3/archive/1.24.52/boto3-1.24.52.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.24.52/boto3-1.24.52.tar.gz
...
%prep
%setup -q -n boto3-1.24.52
cd %{_builddir}/boto3-1.24.52
pushd ..
cp -a boto3-1.24.52 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660592381
