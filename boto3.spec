...
Version  : 1.13.4
Release  : 384
URL      : https://github.com/boto/boto3/archive/1.13.4/boto3-1.13.4.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.13.4/boto3-1.13.4.tar.gz
...
%prep
%setup -q -n boto3-1.13.4
cd %{_builddir}/boto3-1.13.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588800295
...
cp %{_builddir}/boto3-1.13.4/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
