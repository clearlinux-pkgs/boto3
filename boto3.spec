...
Source0  : https://github.com/boto/boto3/archive/1.12.26/boto3-1.12.26.tar.gz
...
%prep
%setup -q -n boto3-1.12.26
cd %{_builddir}/boto3-1.12.26
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584734376
...
cp %{_builddir}/boto3-1.12.26/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
