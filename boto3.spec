...
Source0  : https://github.com/boto/boto3/archive/1.24.16/boto3-1.24.16.tar.gz
...
%prep
%setup -q -n boto3-1.24.16
cd %{_builddir}/boto3-1.24.16
pushd ..
cp -a boto3-1.24.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656024855
...
cp %{_builddir}/boto3-1.24.16/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
