...
Version  : 1.34.65
Release  : 1312
URL      : https://github.com/boto/boto3/archive/1.34.65/boto3-1.34.65.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.65/boto3-1.34.65.tar.gz
...
%prep
%setup -q -n boto3-1.34.65
cd %{_builddir}/boto3-1.34.65
pushd ..
cp -a boto3-1.34.65 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710801836
