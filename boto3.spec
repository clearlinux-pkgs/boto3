...
Source0  : https://github.com/boto/boto3/archive/1.24.42/boto3-1.24.42.tar.gz
...
%prep
%setup -q -n boto3-1.24.42
cd %{_builddir}/boto3-1.24.42
pushd ..
cp -a boto3-1.24.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659221380
