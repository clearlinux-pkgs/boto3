...
Source0  : https://github.com/boto/boto3/archive/1.38.13/boto3-1.38.13.tar.gz
...
%prep
%setup -q -n boto3-1.38.13
cd %{_builddir}/boto3-1.38.13
pushd ..
cp -a boto3-1.38.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746819828
