...
Source0  : https://github.com/boto/boto3/archive/1.35.26/boto3-1.35.26.tar.gz
...
%prep
%setup -q -n boto3-1.35.26
cd %{_builddir}/boto3-1.35.26
pushd ..
cp -a boto3-1.35.26 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727217803
