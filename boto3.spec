...
Source0  : https://github.com/boto/boto3/archive/1.33.9/boto3-1.33.9.tar.gz
...
%prep
%setup -q -n boto3-1.33.9
cd %{_builddir}/boto3-1.33.9
pushd ..
cp -a boto3-1.33.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701937610
