...
Source0  : https://github.com/boto/boto3/archive/1.36.11/boto3-1.36.11.tar.gz
...
%prep
%setup -q -n boto3-1.36.11
cd %{_builddir}/boto3-1.36.11
pushd ..
cp -a boto3-1.36.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738366715
