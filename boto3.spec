...
Version  : 1.23.7
Release  : 857
URL      : https://github.com/boto/boto3/archive/1.23.7/boto3-1.23.7.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.23.7/boto3-1.23.7.tar.gz
...
%prep
%setup -q -n boto3-1.23.7
cd %{_builddir}/boto3-1.23.7
pushd ..
cp -a boto3-1.23.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653427414
...
cp %{_builddir}/boto3-1.23.7/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
