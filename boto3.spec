...
Version  : 1.9.182
Release  : 218
URL      : https://github.com/boto/boto3/archive/1.9.182/boto3-1.9.182.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.9.182/boto3-1.9.182.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562140456
