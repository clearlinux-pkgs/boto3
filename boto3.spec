...
Source0  : https://github.com/boto/boto3/archive/1.26.67/boto3-1.26.67.tar.gz
...
%prep
%setup -q -n boto3-1.26.67
cd %{_builddir}/boto3-1.26.67
pushd ..
cp -a boto3-1.26.67 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675890887
