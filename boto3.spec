...
Source0  : https://github.com/boto/boto3/archive/1.26.43/boto3-1.26.43.tar.gz
...
%prep
%setup -q -n boto3-1.26.43
cd %{_builddir}/boto3-1.26.43
pushd ..
cp -a boto3-1.26.43 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672865783
