...
Version  : 1.10.49
Release  : 325
URL      : https://github.com/boto/boto3/archive/1.10.49/boto3-1.10.49.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.10.49/boto3-1.10.49.tar.gz
...
%prep
%setup -q -n boto3-1.10.49
cd %{_builddir}/boto3-1.10.49
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578597917
...
cp %{_builddir}/boto3-1.10.49/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
