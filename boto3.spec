...
Version  : 1.24.80
Release  : 944
URL      : https://github.com/boto/boto3/archive/1.24.80/boto3-1.24.80.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.24.80/boto3-1.24.80.tar.gz
...
%prep
%setup -q -n boto3-1.24.80
cd %{_builddir}/boto3-1.24.80
pushd ..
cp -a boto3-1.24.80 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663962924
