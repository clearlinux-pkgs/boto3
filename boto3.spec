...
Version  : 1.34.75
Release  : 1322
URL      : https://github.com/boto/boto3/archive/1.34.75/boto3-1.34.75.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.75/boto3-1.34.75.tar.gz
...
%prep
%setup -q -n boto3-1.34.75
cd %{_builddir}/boto3-1.34.75
pushd ..
cp -a boto3-1.34.75 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712006303
