...
Source0  : https://github.com/boto/boto3/archive/1.26.162/boto3-1.26.162.tar.gz
...
%prep
%setup -q -n boto3-1.26.162
cd %{_builddir}/boto3-1.26.162
pushd ..
cp -a boto3-1.26.162 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687906695
