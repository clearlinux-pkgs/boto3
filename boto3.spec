...
Version  : 1.38.21
Release  : 1587
URL      : https://github.com/boto/boto3/archive/1.38.21/boto3-1.38.21.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.38.21/boto3-1.38.21.tar.gz
...
%prep
%setup -q -n boto3-1.38.21
cd %{_builddir}/boto3-1.38.21
pushd ..
cp -a boto3-1.38.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747857520
