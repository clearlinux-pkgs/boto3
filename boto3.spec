...
Version  : 1.34.115
Release  : 1362
URL      : https://github.com/boto/boto3/archive/1.34.115/boto3-1.34.115.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.115/boto3-1.34.115.tar.gz
...
%prep
%setup -q -n boto3-1.34.115
cd %{_builddir}/boto3-1.34.115
pushd ..
cp -a boto3-1.34.115 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717011640
