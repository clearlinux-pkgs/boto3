...
Source0  : https://github.com/boto/boto3/archive/1.24.20/boto3-1.24.20.tar.gz
...
%prep
%setup -q -n boto3-1.24.20
cd %{_builddir}/boto3-1.24.20
pushd ..
cp -a boto3-1.24.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656532053
...
cp %{_builddir}/boto3-1.24.20/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
