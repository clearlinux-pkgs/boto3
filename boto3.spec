...
Version  : 1.39.2
Release  : 1614
URL      : https://github.com/boto/boto3/archive/1.39.2/boto3-1.39.2.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.39.2/boto3-1.39.2.tar.gz
...
%prep
%setup -q -n boto3-1.39.2
cd %{_builddir}/boto3-1.39.2
pushd ..
cp -a boto3-1.39.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751493793
