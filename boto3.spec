...
Source0  : https://github.com/boto/boto3/archive/1.26.85/boto3-1.26.85.tar.gz
...
%prep
%setup -q -n boto3-1.26.85
cd %{_builddir}/boto3-1.26.85
pushd ..
cp -a boto3-1.26.85 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678135064
