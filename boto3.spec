...
Source0  : https://github.com/boto/boto3/archive/1.34.97/boto3-1.34.97.tar.gz
...
%prep
%setup -q -n boto3-1.34.97
cd %{_builddir}/boto3-1.34.97
pushd ..
cp -a boto3-1.34.97 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714680164
