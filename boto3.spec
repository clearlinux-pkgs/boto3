...
Source0  : https://github.com/boto/boto3/archive/1.26.23/boto3-1.26.23.tar.gz
...
%prep
%setup -q -n boto3-1.26.23
cd %{_builddir}/boto3-1.26.23
pushd ..
cp -a boto3-1.26.23 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670272783
