...
Version  : 1.24.48
Release  : 908
URL      : https://github.com/boto/boto3/archive/1.24.48/boto3-1.24.48.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.24.48/boto3-1.24.48.tar.gz
...
%prep
%setup -q -n boto3-1.24.48
cd %{_builddir}/boto3-1.24.48
pushd ..
cp -a boto3-1.24.48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660075384
