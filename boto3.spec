...
Source0  : https://github.com/boto/boto3/archive/1.28.70/boto3-1.28.70.tar.gz
...
%prep
%setup -q -n boto3-1.28.70
cd %{_builddir}/boto3-1.28.70
pushd ..
cp -a boto3-1.28.70 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698187564
