...
Version  : 1.34.48
Release  : 1295
URL      : https://github.com/boto/boto3/archive/1.34.48/boto3-1.34.48.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.48/boto3-1.34.48.tar.gz
...
%prep
%setup -q -n boto3-1.34.48
cd %{_builddir}/boto3-1.34.48
pushd ..
cp -a boto3-1.34.48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708635137
