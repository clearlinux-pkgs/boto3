...
Source0  : https://github.com/boto/boto3/archive/1.37.1/boto3-1.37.1.tar.gz
...
%prep
%setup -q -n boto3-1.37.1
cd %{_builddir}/boto3-1.37.1
pushd ..
cp -a boto3-1.37.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740516431
