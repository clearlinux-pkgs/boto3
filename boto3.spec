...
Source0  : https://github.com/boto/boto3/archive/1.17.110/boto3-1.17.110.tar.gz
...
%prep
%setup -q -n boto3-1.17.110
cd %{_builddir}/boto3-1.17.110
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626186757
...
cp %{_builddir}/boto3-1.17.110/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
