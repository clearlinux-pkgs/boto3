...
Version  : 1.16.55
Release  : 533
URL      : https://github.com/boto/boto3/archive/1.16.55/boto3-1.16.55.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.16.55/boto3-1.16.55.tar.gz
...
%prep
%setup -q -n boto3-1.16.55
cd %{_builddir}/boto3-1.16.55
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610670816
...
cp %{_builddir}/boto3-1.16.55/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
