...
Version  : 1.24.8
Release  : 869
URL      : https://github.com/boto/boto3/archive/1.24.8/boto3-1.24.8.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.24.8/boto3-1.24.8.tar.gz
...
%prep
%setup -q -n boto3-1.24.8
cd %{_builddir}/boto3-1.24.8
pushd ..
cp -a boto3-1.24.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655160461
...
cp %{_builddir}/boto3-1.24.8/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
