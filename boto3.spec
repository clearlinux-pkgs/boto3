...
Version  : 1.26.131
Release  : 1099
URL      : https://github.com/boto/boto3/archive/1.26.131/boto3-1.26.131.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.131/boto3-1.26.131.tar.gz
...
%prep
%setup -q -n boto3-1.26.131
cd %{_builddir}/boto3-1.26.131
pushd ..
cp -a boto3-1.26.131 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683661433
