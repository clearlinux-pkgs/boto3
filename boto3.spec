...
Source0  : https://github.com/boto/boto3/archive/1.26.102/boto3-1.26.102.tar.gz
...
%prep
%setup -q -n boto3-1.26.102
cd %{_builddir}/boto3-1.26.102
pushd ..
cp -a boto3-1.26.102 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680118740
