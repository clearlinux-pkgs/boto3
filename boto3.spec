...
Version  : 1.34.123
Release  : 1370
URL      : https://github.com/boto/boto3/archive/1.34.123/boto3-1.34.123.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.123/boto3-1.34.123.tar.gz
...
%prep
%setup -q -n boto3-1.34.123
cd %{_builddir}/boto3-1.34.123
pushd ..
cp -a boto3-1.34.123 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718049986
