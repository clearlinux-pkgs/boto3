...
Source0  : https://github.com/boto/boto3/archive/1.16.10/boto3-1.16.10.tar.gz
...
%prep
%setup -q -n boto3-1.16.10
cd %{_builddir}/boto3-1.16.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604508057
...
cp %{_builddir}/boto3-1.16.10/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
