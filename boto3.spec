...
Version  : 1.14.28
Release  : 435
URL      : https://github.com/boto/boto3/archive/1.14.28/boto3-1.14.28.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.14.28/boto3-1.14.28.tar.gz
...
%prep
%setup -q -n boto3-1.14.28
cd %{_builddir}/boto3-1.14.28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595863435
...
cp %{_builddir}/boto3-1.14.28/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
