...
Source0  : https://github.com/boto/boto3/archive/1.26.35/boto3-1.26.35.tar.gz
...
%prep
%setup -q -n boto3-1.26.35
cd %{_builddir}/boto3-1.26.35
pushd ..
cp -a boto3-1.26.35 buildavx2
cp -a boto3-1.26.35 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671665948
