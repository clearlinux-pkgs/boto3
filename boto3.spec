...
Version  : 1.28.81
Release  : 1219
URL      : https://github.com/boto/boto3/archive/1.28.81/boto3-1.28.81.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.28.81/boto3-1.28.81.tar.gz
...
%prep
%setup -q -n boto3-1.28.81
cd %{_builddir}/boto3-1.28.81
pushd ..
cp -a boto3-1.28.81 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699486923
