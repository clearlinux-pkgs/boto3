...
Version  : 1.26.128
Release  : 1096
URL      : https://github.com/boto/boto3/archive/1.26.128/boto3-1.26.128.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.128/boto3-1.26.128.tar.gz
...
%prep
%setup -q -n boto3-1.26.128
cd %{_builddir}/boto3-1.26.128
pushd ..
cp -a boto3-1.26.128 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683315689
