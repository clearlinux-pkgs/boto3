...
Version  : 1.16.49
Release  : 527
URL      : https://github.com/boto/boto3/archive/1.16.49/boto3-1.16.49.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.16.49/boto3-1.16.49.tar.gz
...
%prep
%setup -q -n boto3-1.16.49
cd %{_builddir}/boto3-1.16.49
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609879400
...
cp %{_builddir}/boto3-1.16.49/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
