...
Source0  : https://github.com/boto/boto3/archive/1.38.6/boto3-1.38.6.tar.gz
...
%prep
%setup -q -n boto3-1.38.6
cd %{_builddir}/boto3-1.38.6
pushd ..
cp -a boto3-1.38.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746053203
