...
Version  : 1.35.96
Release  : 1500
URL      : https://github.com/boto/boto3/archive/1.35.96/boto3-1.35.96.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.35.96/boto3-1.35.96.tar.gz
...
%prep
%setup -q -n boto3-1.35.96
cd %{_builddir}/boto3-1.35.96
pushd ..
cp -a boto3-1.35.96 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736455440
