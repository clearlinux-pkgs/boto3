...
Version  : 1.34.23
Release  : 1270
URL      : https://github.com/boto/boto3/archive/1.34.23/boto3-1.34.23.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.23/boto3-1.34.23.tar.gz
...
%prep
%setup -q -n boto3-1.34.23
cd %{_builddir}/boto3-1.34.23
pushd ..
cp -a boto3-1.34.23 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705707923
