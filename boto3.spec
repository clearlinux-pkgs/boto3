...
Source0  : https://github.com/boto/boto3/archive/1.12.3/boto3-1.12.3.tar.gz
...
%prep
%setup -q -n boto3-1.12.3
cd %{_builddir}/boto3-1.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582161049
...
cp %{_builddir}/boto3-1.12.3/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
