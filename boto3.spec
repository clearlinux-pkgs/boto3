...
Source0  : https://github.com/boto/boto3/archive/1.34.127/boto3-1.34.127.tar.gz
...
%prep
%setup -q -n boto3-1.34.127
cd %{_builddir}/boto3-1.34.127
pushd ..
cp -a boto3-1.34.127 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718395128
