...
Source0  : https://github.com/boto/boto3/archive/1.37.30/boto3-1.37.30.tar.gz
...
%prep
%setup -q -n boto3-1.37.30
cd %{_builddir}/boto3-1.37.30
pushd ..
cp -a boto3-1.37.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744152565
