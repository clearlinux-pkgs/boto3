...
Version  : 1.34.93
Release  : 1340
URL      : https://github.com/boto/boto3/archive/1.34.93/boto3-1.34.93.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.93/boto3-1.34.93.tar.gz
...
%prep
%setup -q -n boto3-1.34.93
cd %{_builddir}/boto3-1.34.93
pushd ..
cp -a boto3-1.34.93 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714161082
