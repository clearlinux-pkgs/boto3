...
Version  : 1.22.0
Release  : 836
URL      : https://github.com/boto/boto3/archive/1.22.0/boto3-1.22.0.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.22.0/boto3-1.22.0.tar.gz
...
%prep
%setup -q -n boto3-1.22.0
cd %{_builddir}/boto3-1.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650916423
...
cp %{_builddir}/boto3-1.22.0/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
