...
Version  : 1.28.20
Release  : 1156
URL      : https://github.com/boto/boto3/archive/1.28.20/boto3-1.28.20.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.28.20/boto3-1.28.20.tar.gz
...
%prep
%setup -q -n boto3-1.28.20
cd %{_builddir}/boto3-1.28.20
pushd ..
cp -a boto3-1.28.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691423634
