...
Version  : 1.26.114
Release  : 1083
URL      : https://github.com/boto/boto3/archive/1.26.114/boto3-1.26.114.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.114/boto3-1.26.114.tar.gz
...
%prep
%setup -q -n boto3-1.26.114
cd %{_builddir}/boto3-1.26.114
pushd ..
cp -a boto3-1.26.114 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681501602
