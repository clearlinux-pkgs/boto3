...
Source0  : https://github.com/boto/boto3/archive/1.25.3/boto3-1.25.3.tar.gz
...
%prep
%setup -q -n boto3-1.25.3
cd %{_builddir}/boto3-1.25.3
pushd ..
cp -a boto3-1.25.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666910435
