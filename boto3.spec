...
Version  : 1.17.109
Release  : 649
URL      : https://github.com/boto/boto3/archive/1.17.109/boto3-1.17.109.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.17.109/boto3-1.17.109.tar.gz
...
%prep
%setup -q -n boto3-1.17.109
cd %{_builddir}/boto3-1.17.109
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626102098
...
cp %{_builddir}/boto3-1.17.109/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
