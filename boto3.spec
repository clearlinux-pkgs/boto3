...
%prep
%setup -q -n boto3-1.19.7
cd %{_builddir}/boto3-1.19.7
...
cp %{_builddir}/boto3-1.19.7/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
