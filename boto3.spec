...
Version  : 1.24.56
Release  : 918
URL      : https://github.com/boto/boto3/archive/1.24.56/boto3-1.24.56.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.24.56/boto3-1.24.56.tar.gz
...
%prep
%setup -q -n boto3-1.24.56
cd %{_builddir}/boto3-1.24.56
pushd ..
cp -a boto3-1.24.56 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661189185
