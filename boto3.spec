...
Source0  : https://github.com/boto/boto3/archive/1.34.25/boto3-1.34.25.tar.gz
...
%prep
%setup -q -n boto3-1.34.25
cd %{_builddir}/boto3-1.34.25
pushd ..
cp -a boto3-1.34.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705977265
