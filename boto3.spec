...
Version  : 1.28.57
Release  : 1195
URL      : https://github.com/boto/boto3/archive/1.28.57/boto3-1.28.57.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.28.57/boto3-1.28.57.tar.gz
...
%prep
%setup -q -n boto3-1.28.57
cd %{_builddir}/boto3-1.28.57
pushd ..
cp -a boto3-1.28.57 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695930564
