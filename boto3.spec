...
Version  : 1.16.14
Release  : 497
URL      : https://github.com/boto/boto3/archive/1.16.14/boto3-1.16.14.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.16.14/boto3-1.16.14.tar.gz
...
%prep
%setup -q -n boto3-1.16.14
cd %{_builddir}/boto3-1.16.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604971097
...
cp %{_builddir}/boto3-1.16.14/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
