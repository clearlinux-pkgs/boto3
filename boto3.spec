...
Version  : 1.34.31
Release  : 1278
URL      : https://github.com/boto/boto3/archive/1.34.31/boto3-1.34.31.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.31/boto3-1.34.31.tar.gz
...
%prep
%setup -q -n boto3-1.34.31
cd %{_builddir}/boto3-1.34.31
pushd ..
cp -a boto3-1.34.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706647197
