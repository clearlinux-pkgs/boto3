...
Source0  : https://github.com/boto/boto3/archive/1.34.16/boto3-1.34.16.tar.gz
...
%prep
%setup -q -n boto3-1.34.16
cd %{_builddir}/boto3-1.34.16
pushd ..
cp -a boto3-1.34.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704919132
