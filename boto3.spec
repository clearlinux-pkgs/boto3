...
Version  : 1.20.30
Release  : 763
URL      : https://github.com/boto/boto3/archive/1.20.30/boto3-1.20.30.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.20.30/boto3-1.20.30.tar.gz
...
%prep
%setup -q -n boto3-1.20.30
cd %{_builddir}/boto3-1.20.30
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641502258
...
cp %{_builddir}/boto3-1.20.30/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
