...
Version  : 1.33.6
Release  : 1238
URL      : https://github.com/boto/boto3/archive/1.33.6/boto3-1.33.6.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.33.6/boto3-1.33.6.tar.gz
...
%prep
%setup -q -n boto3-1.33.6
cd %{_builddir}/boto3-1.33.6
pushd ..
cp -a boto3-1.33.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701463545
