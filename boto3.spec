...
Source0  : https://github.com/boto/boto3/archive/1.24.18/boto3-1.24.18.tar.gz
...
%prep
%setup -q -n boto3-1.24.18
cd %{_builddir}/boto3-1.24.18
pushd ..
cp -a boto3-1.24.18 buildavx2
popd
...
cp %{_builddir}/boto3-1.24.18/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
