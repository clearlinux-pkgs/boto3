...
Version  : 1.26.31
Release  : 1000
URL      : https://github.com/boto/boto3/archive/1.26.31/boto3-1.26.31.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.31/boto3-1.26.31.tar.gz
...
%prep
%setup -q -n boto3-1.26.31
cd %{_builddir}/boto3-1.26.31
pushd ..
cp -a boto3-1.26.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671137146
