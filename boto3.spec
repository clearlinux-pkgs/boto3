...
Version  : 1.35.49
Release  : 1460
URL      : https://github.com/boto/boto3/archive/1.35.49/boto3-1.35.49.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.35.49/boto3-1.35.49.tar.gz
...
%prep
%setup -q -n boto3-1.35.49
cd %{_builddir}/boto3-1.35.49
pushd ..
cp -a boto3-1.35.49 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729893114
