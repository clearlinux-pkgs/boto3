...
Version  : 1.15.16
Release  : 480
URL      : https://github.com/boto/boto3/archive/1.15.16/boto3-1.15.16.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.15.16/boto3-1.15.16.tar.gz
...
%prep
%setup -q -n boto3-1.15.16
cd %{_builddir}/boto3-1.15.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602518481
...
cp %{_builddir}/boto3-1.15.16/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
