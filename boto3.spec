...
Version  : 1.9.156
Release  : 193
URL      : https://github.com/boto/boto3/archive/1.9.156/boto3-1.9.156.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.9.156/boto3-1.9.156.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1558819382
export AR=gcc-ar
