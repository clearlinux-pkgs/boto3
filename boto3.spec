...
Source0  : https://github.com/boto/boto3/archive/1.26.94/boto3-1.26.94.tar.gz
...
%prep
%setup -q -n boto3-1.26.94
cd %{_builddir}/boto3-1.26.94
pushd ..
cp -a boto3-1.26.94 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679083470
