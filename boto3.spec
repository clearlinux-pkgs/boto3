...
Version  : 1.38.42
Release  : 1607
URL      : https://github.com/boto/boto3/archive/1.38.42/boto3-1.38.42.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.38.42/boto3-1.38.42.tar.gz
...
%prep
%setup -q -n boto3-1.38.42
cd %{_builddir}/boto3-1.38.42
pushd ..
cp -a boto3-1.38.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750708623
