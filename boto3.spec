...
Version  : 1.35.55
Release  : 1467
URL      : https://github.com/boto/boto3/archive/1.35.55/boto3-1.35.55.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.35.55/boto3-1.35.55.tar.gz
...
%prep
%setup -q -n boto3-1.35.55
cd %{_builddir}/boto3-1.35.55
pushd ..
cp -a boto3-1.35.55 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730925847
