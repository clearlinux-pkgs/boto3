...
Version  : 1.34.72
Release  : 1319
URL      : https://github.com/boto/boto3/archive/1.34.72/boto3-1.34.72.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.72/boto3-1.34.72.tar.gz
...
%prep
%setup -q -n boto3-1.34.72
cd %{_builddir}/boto3-1.34.72
pushd ..
cp -a boto3-1.34.72 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711568267
