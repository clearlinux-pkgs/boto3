...
Version  : 1.26.101
Release  : 1070
URL      : https://github.com/boto/boto3/archive/1.26.101/boto3-1.26.101.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.101/boto3-1.26.101.tar.gz
...
%prep
%setup -q -n boto3-1.26.101
cd %{_builddir}/boto3-1.26.101
pushd ..
cp -a boto3-1.26.101 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680044213
