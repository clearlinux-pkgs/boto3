...
Version  : 1.24.60
Release  : 924
URL      : https://github.com/boto/boto3/archive/1.24.60/boto3-1.24.60.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.24.60/boto3-1.24.60.tar.gz
...
%prep
%setup -q -n boto3-1.24.60
cd %{_builddir}/boto3-1.24.60
pushd ..
cp -a boto3-1.24.60 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661467060
