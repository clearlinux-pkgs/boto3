...
Source0  : https://github.com/boto/boto3/archive/1.24.19/boto3-1.24.19.tar.gz
...
%prep
%setup -q -n boto3-1.24.19
cd %{_builddir}/boto3-1.24.19
pushd ..
cp -a boto3-1.24.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656446440
...
cp %{_builddir}/boto3-1.24.19/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
