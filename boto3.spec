...
Version  : 1.26.56
Release  : 1025
URL      : https://github.com/boto/boto3/archive/1.26.56/boto3-1.26.56.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.56/boto3-1.26.56.tar.gz
...
%prep
%setup -q -n boto3-1.26.56
cd %{_builddir}/boto3-1.26.56
pushd ..
cp -a boto3-1.26.56 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674592880
