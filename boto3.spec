...
Version  : 1.26.134
Release  : 1102
URL      : https://github.com/boto/boto3/archive/1.26.134/boto3-1.26.134.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.134/boto3-1.26.134.tar.gz
...
%prep
%setup -q -n boto3-1.26.134
cd %{_builddir}/boto3-1.26.134
pushd ..
cp -a boto3-1.26.134 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684190805
