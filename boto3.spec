...
Version  : 1.36.24
Release  : 1528
URL      : https://github.com/boto/boto3/archive/1.36.24/boto3-1.36.24.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.36.24/boto3-1.36.24.tar.gz
...
%prep
%setup -q -n boto3-1.36.24
cd %{_builddir}/boto3-1.36.24
pushd ..
cp -a boto3-1.36.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739997283
