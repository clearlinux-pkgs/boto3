...
Version  : 1.9.241
Release  : 272
URL      : https://github.com/boto/boto3/archive/1.9.241/boto3-1.9.241.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.9.241/boto3-1.9.241.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570060426
