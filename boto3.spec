...
Version  : 1.18.12
Release  : 666
URL      : https://github.com/boto/boto3/archive/1.18.12/boto3-1.18.12.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.18.12/boto3-1.18.12.tar.gz
...
%prep
%setup -q -n boto3-1.18.12
cd %{_builddir}/boto3-1.18.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628000635
...
cp %{_builddir}/boto3-1.18.12/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
