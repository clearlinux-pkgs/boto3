...
Source0  : https://github.com/boto/boto3/archive/1.35.68/boto3-1.35.68.tar.gz
...
%prep
%setup -q -n boto3-1.35.68
cd %{_builddir}/boto3-1.35.68
pushd ..
cp -a boto3-1.35.68 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732308444
