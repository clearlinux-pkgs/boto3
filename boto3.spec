...
Version  : 1.28.23
Release  : 1159
URL      : https://github.com/boto/boto3/archive/1.28.23/boto3-1.28.23.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.28.23/boto3-1.28.23.tar.gz
...
%prep
%setup -q -n boto3-1.28.23
cd %{_builddir}/boto3-1.28.23
pushd ..
cp -a boto3-1.28.23 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691610532
