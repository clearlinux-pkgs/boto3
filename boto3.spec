...
Version  : 1.34.47
Release  : 1294
URL      : https://github.com/boto/boto3/archive/1.34.47/boto3-1.34.47.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.47/boto3-1.34.47.tar.gz
...
%prep
%setup -q -n boto3-1.34.47
cd %{_builddir}/boto3-1.34.47
pushd ..
cp -a boto3-1.34.47 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708558673
