...
Version  : 1.35.84
Release  : 1490
URL      : https://github.com/boto/boto3/archive/1.35.84/boto3-1.35.84.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.35.84/boto3-1.35.84.tar.gz
...
%prep
%setup -q -n boto3-1.35.84
cd %{_builddir}/boto3-1.35.84
pushd ..
cp -a boto3-1.35.84 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1734589582
