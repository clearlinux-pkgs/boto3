...
Version  : 1.38.8
Release  : 1574
URL      : https://github.com/boto/boto3/archive/1.38.8/boto3-1.38.8.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.38.8/boto3-1.38.8.tar.gz
...
%prep
%setup -q -n boto3-1.38.8
cd %{_builddir}/boto3-1.38.8
pushd ..
cp -a boto3-1.38.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746236659
