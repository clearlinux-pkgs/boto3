...
Version  : 1.34.9
Release  : 1256
URL      : https://github.com/boto/boto3/archive/1.34.9/boto3-1.34.9.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.9/boto3-1.34.9.tar.gz
...
%prep
%setup -q -n boto3-1.34.9
cd %{_builddir}/boto3-1.34.9
pushd ..
cp -a boto3-1.34.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703710551
