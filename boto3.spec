...
Version  : 1.28.79
Release  : 1217
URL      : https://github.com/boto/boto3/archive/1.28.79/boto3-1.28.79.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.28.79/boto3-1.28.79.tar.gz
...
%prep
%setup -q -n boto3-1.28.79
cd %{_builddir}/boto3-1.28.79
pushd ..
cp -a boto3-1.28.79 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699314042
