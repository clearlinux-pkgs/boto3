...
Version  : 1.35.91
Release  : 1495
URL      : https://github.com/boto/boto3/archive/1.35.91/boto3-1.35.91.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.35.91/boto3-1.35.91.tar.gz
...
%prep
%setup -q -n boto3-1.35.91
cd %{_builddir}/boto3-1.35.91
pushd ..
cp -a boto3-1.35.91 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735850548
