...
Source0  : https://github.com/boto/boto3/archive/1.17.51/boto3-1.17.51.tar.gz
...
%prep
%setup -q -n boto3-1.17.51
cd %{_builddir}/boto3-1.17.51
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618409561
...
cp %{_builddir}/boto3-1.17.51/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
