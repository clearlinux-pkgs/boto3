...
Version  : 1.26.138
Release  : 1106
URL      : https://github.com/boto/boto3/archive/1.26.138/boto3-1.26.138.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.138/boto3-1.26.138.tar.gz
...
%prep
%setup -q -n boto3-1.26.138
cd %{_builddir}/boto3-1.26.138
pushd ..
cp -a boto3-1.26.138 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684784232
