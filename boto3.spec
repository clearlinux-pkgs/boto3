...
Version  : 1.28.22
Release  : 1158
URL      : https://github.com/boto/boto3/archive/1.28.22/boto3-1.28.22.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.28.22/boto3-1.28.22.tar.gz
...
%prep
%setup -q -n boto3-1.28.22
cd %{_builddir}/boto3-1.28.22
pushd ..
cp -a boto3-1.28.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691524464
