...
Version  : 1.34.46
Release  : 1293
URL      : https://github.com/boto/boto3/archive/1.34.46/boto3-1.34.46.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.46/boto3-1.34.46.tar.gz
...
%prep
%setup -q -n boto3-1.34.46
cd %{_builddir}/boto3-1.34.46
pushd ..
cp -a boto3-1.34.46 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708461871
