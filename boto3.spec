...
Version  : 1.34.134
Release  : 1381
URL      : https://github.com/boto/boto3/archive/1.34.134/boto3-1.34.134.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.134/boto3-1.34.134.tar.gz
...
%prep
%setup -q -n boto3-1.34.134
cd %{_builddir}/boto3-1.34.134
pushd ..
cp -a boto3-1.34.134 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719432709
