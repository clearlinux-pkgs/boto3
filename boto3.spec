...
Version  : 1.22.10
Release  : 846
URL      : https://github.com/boto/boto3/archive/1.22.10/boto3-1.22.10.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.22.10/boto3-1.22.10.tar.gz
...
%prep
%setup -q -n boto3-1.22.10
cd %{_builddir}/boto3-1.22.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652128727
...
cp %{_builddir}/boto3-1.22.10/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
