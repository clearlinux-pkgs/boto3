...
Version  : 1.26.79
Release  : 1048
URL      : https://github.com/boto/boto3/archive/1.26.79/boto3-1.26.79.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.79/boto3-1.26.79.tar.gz
...
%prep
%setup -q -n boto3-1.26.79
cd %{_builddir}/boto3-1.26.79
pushd ..
cp -a boto3-1.26.79 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677281879
