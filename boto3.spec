...
Version  : 1.24.94
Release  : 958
URL      : https://github.com/boto/boto3/archive/1.24.94/boto3-1.24.94.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.24.94/boto3-1.24.94.tar.gz
...
%prep
%setup -q -n boto3-1.24.94
cd %{_builddir}/boto3-1.24.94
pushd ..
cp -a boto3-1.24.94 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666209228
