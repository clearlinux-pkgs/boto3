...
Version  : 1.17.46
Release  : 588
URL      : https://github.com/boto/boto3/archive/1.17.46/boto3-1.17.46.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.17.46/boto3-1.17.46.tar.gz
...
%prep
%setup -q -n boto3-1.17.46
cd %{_builddir}/boto3-1.17.46
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617808410
...
cp %{_builddir}/boto3-1.17.46/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
