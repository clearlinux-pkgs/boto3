...
Version  : 1.35.18
Release  : 1428
URL      : https://github.com/boto/boto3/archive/1.35.18/boto3-1.35.18.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.35.18/boto3-1.35.18.tar.gz
...
%prep
%setup -q -n boto3-1.35.18
cd %{_builddir}/boto3-1.35.18
pushd ..
cp -a boto3-1.35.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726170239
