...
Source0  : https://github.com/boto/boto3/archive/1.26.7/boto3-1.26.7.tar.gz
...
%prep
%setup -q -n boto3-1.26.7
cd %{_builddir}/boto3-1.26.7
pushd ..
cp -a boto3-1.26.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668117255
