...
Version  : 1.38.5
Release  : 1571
URL      : https://github.com/boto/boto3/archive/1.38.5/boto3-1.38.5.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.38.5/boto3-1.38.5.tar.gz
...
%prep
%setup -q -n boto3-1.38.5
cd %{_builddir}/boto3-1.38.5
pushd ..
cp -a boto3-1.38.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745956060
