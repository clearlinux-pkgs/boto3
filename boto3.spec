...
Version  : 1.21.45
Release  : 834
URL      : https://github.com/boto/boto3/archive/1.21.45/boto3-1.21.45.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.21.45/boto3-1.21.45.tar.gz
...
%prep
%setup -q -n boto3-1.21.45
cd %{_builddir}/boto3-1.21.45
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650570244
...
cp %{_builddir}/boto3-1.21.45/LICENSE %{buildroot}/usr/share/package-licenses/boto3/598f87f072f66e2269dd6919292b2934dbb20492
