...
Source0  : https://github.com/boto/boto3/archive/1.29.0/boto3-1.29.0.tar.gz
...
%prep
%setup -q -n boto3-1.29.0
cd %{_builddir}/boto3-1.29.0
pushd ..
cp -a boto3-1.29.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700004991
