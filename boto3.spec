...
Version  : 1.34.76
Release  : 1323
URL      : https://github.com/boto/boto3/archive/1.34.76/boto3-1.34.76.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.34.76/boto3-1.34.76.tar.gz
...
%prep
%setup -q -n boto3-1.34.76
cd %{_builddir}/boto3-1.34.76
pushd ..
cp -a boto3-1.34.76 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712087590
