...
Version  : 1.26.37
Release  : 1006
URL      : https://github.com/boto/boto3/archive/1.26.37/boto3-1.26.37.tar.gz
Source0  : https://github.com/boto/boto3/archive/1.26.37/boto3-1.26.37.tar.gz
...
%prep
%setup -q -n boto3-1.26.37
cd %{_builddir}/boto3-1.26.37
pushd ..
cp -a boto3-1.26.37 buildavx2
cp -a boto3-1.26.37 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671828494
