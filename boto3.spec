...
Source0  : https://github.com/boto/boto3/archive/1.38.40/boto3-1.38.40.tar.gz
...
%prep
%setup -q -n boto3-1.38.40
cd %{_builddir}/boto3-1.38.40
pushd ..
cp -a boto3-1.38.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750362693
